...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7406407460:AAESLPX9693aP_y_-dENmsDPgY4L8qkRxE4")
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002132223146"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1001930406310"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002192499985"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_PIC = os.environ.get("START_PIC", "https://envs.sh/Pah.jpg")
...
try:
    ADMINS=[5585016974]
    for x in (os.environ.get("ADMINS", "5585016974 5585016974 5585016974 5585016974").split()):
        ADMINS.append(int(x))
except ValueError:
